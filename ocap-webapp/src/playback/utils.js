...
function getUnitById (unitId) {
  if (unitId in recordingData.playbackUnits) {
    return recordingData.playbackUnits[unitId];
  } else {
    return -1;
  };
};
...
function animateBulletInterval (callback, feature, delay, repetitions) {
  var x = 0;
